...
// Returns the private 'App\Repository\PlatsRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/PlatsRepository.php';

return $this->privates['App\\Repository\\PlatsRepository'] = new \App\Repository\PlatsRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
