...
class __TwigTemplate_be065e46061a279f1e7437e669fc9acf66a045ca5299fc9e46ebd65d3331c968 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
    ...
    <section class='selectproject row'>
        <picture class=\"row col-12 mb-3 mb-lg-0 col-lg-6\">
            <img src=\"";
        // line 15
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl(("build/images/" . twig_get_attribute($this->env, $this->source, (isset($context["projet"]) || array_key_exists("projet", $context) ? $context["projet"] : (function () { throw new RuntimeError('Variable "projet" does not exist.', 15, $this->source); })()), "img", [], "any", false, false, false, 15))), "html", null, true);
        ...
        <a class=\"linkprojet btn btn-primary\" href=\"#\" role=\"button\">Go</a>
    </section>
...
";
    ...
    {
        return array (  126 => 27,  113 => 19,  109 => 18,  103 => 15,  98 => 12,  91 => 11,  82 => 7,  79 => 6,  72 => 5,  62 => 3,  55 => 2,  38 => 1,);
    }
...
{% block body %}
    ...
    <section class='selectproject row'>
        <picture class=\"row col-12 mb-3 mb-lg-0 col-lg-6\">
            <img src=\"{{ asset('build/images/' ~ projet.img) }}\" alt=\"image du projet\">
        </picture>
        <article class=\"description col-12 col-lg-6\">
            <h1>{{ projet.title }}</h1>
