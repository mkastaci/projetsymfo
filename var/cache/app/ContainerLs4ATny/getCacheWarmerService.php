...
return $this->services['cache_warmer'] = new \Symfony\Component\HttpKernel\CacheWarmer\CacheWarmerAggregate(new RewindableGenerator(function () {
    ...
    yield 8 => ($this->privates['webpack_encore.entrypoint_lookup.cache_warmer'] ?? $this->load('getWebpackEncore_EntrypointLookup_CacheWarmerService.php'));
}, 9), true, ($this->targetDirs[0].'/srcApp_KernelAppDebugContainerDeprecations.log'));
