 ...
 */
class srcApp_KernelAppDebugContainer extends Container
{
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'debug.container.dump': $value = ($this->targetDirs[0].'/srcApp_KernelAppDebugContainer.xml'); break;
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.container_class' => 'srcApp_KernelAppDebugContainer',
            ...
            'router.cache_class_prefix' => 'srcApp_KernelAppDebugContainer',
